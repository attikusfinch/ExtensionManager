...
/**
 * Создает и подписывает external message для установки плагина (op = 2)
 */
export async function createInstallPluginExternalMessage(
    ...
    try {
        console.log('🔐 Создание external message для установки плагина');
        ...
        console.log('✅ External message для op=2 создан, размер:', boc.length);

        return boc;
    } catch (error) {
        console.error('❌ Ошибка создания external message для установки:', error);
        throw error;
    }
}
